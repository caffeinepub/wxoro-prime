...
import type { Order as _Order, OrderId as _OrderId, OrderStatus as _OrderStatus, ProductId as _ProductId, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addProduct(arg0: string, arg1: string, arg2: bigint, arg3: string, arg4: string): Promise<ProductId> {
        if (this.processError) {
            try {
    ...
    async editProduct(arg0: ProductId, arg1: string, arg2: string, arg3: bigint, arg4: string, arg5: string, arg6: boolean): Promise<void> {
        if (this.processError) {
            try {
