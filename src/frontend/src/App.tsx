  ...
  return (
    <div className="min-h-screen bg-background font-body">
      ...
      >
        <div className="glass border-b border-primary/10">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-between">
            <div className="font-display font-bold text-xl gradient-text tracking-tight">
              WX Prime
            </div>
            <nav className="flex items-center gap-3 sm:gap-4">
              ...
              <a
                href="https://instagram.com/wx_zoro_prime"
                target="_blank"
                rel="noopener noreferrer"
                className="text-muted-foreground hover:text-primary transition-colors p-1.5"
                aria-label="Instagram"
              ...
              {isLoggedIn ? (
                ...
                <button
                  ...
                  className="btn-gold px-4 py-1.5 rounded-full text-sm font-semibold"
      ...
      <main>
        ...
        />
        <ProductsGrid onBuyClick={handleBuyClick} isLoggedIn={isLoggedIn} />
        {isLoggedIn && <MyOrders />}
